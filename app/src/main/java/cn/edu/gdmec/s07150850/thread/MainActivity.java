package cn.edu.gdmec.s07150850.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date thslastDay=new Date(117,5,23);
        Date toDay=new Date();
        seconds=(int)(thslastDay.getTime()-toDay.getTime())/1000;
    }
    ...
    public void handlermessage(View v){
       final android.os.Handler myHandler=new android.os.Handler(){
        ...
        class MyTask extends TimerTask{
            int countdown;
            double achievment1=1,achievement2=1;
